...
Commande::Commande( QDate dateLiv, int quantite, QDate dateCmd, QString status)
     :dateLivraison(dateLiv), QuantiteC(quantite), dateCommande(dateCmd), etat(status) {}
...
bool Commande::ajouter() {
    ...
    QSqlQuery query;
    query.prepare("INSERT INTO COMMANDE (DATEC, QUANC, DATECL, ETAT) "
                  "VALUES (:DATEC, :QUANC, :DATECL, :ETAT)");
